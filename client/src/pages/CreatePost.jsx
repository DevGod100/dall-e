...
const CreatePost = () => {
  ...
  const [errorMessage, setErrorMessage] = useState('');//chatgpt
    ...
    <section className="max-w-7xl mx-auto">
      ...
      <h1 className="font-extrabold text-[#222328] text-[32px]">Create</h1>
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">
          Generate an imaginative image with DALL-E AI & share it with the community</p>
      </div>
      <div>
     ...
     {generatingImg && (
        ...
        <div className="mt-10">
          ...
          <button
            type="submit"
            className="mt-3 text-white bg-[#ba74ee] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
